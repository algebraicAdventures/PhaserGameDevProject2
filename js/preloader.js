 ...
 */
var totalDecodedSounds = 29; //Set to the number of mp3's/ ogg's you have, needs to be equal to that number
function loadStuff(game){
    ...
    game.load.audio('machineStatic', 'SFX/Machine_Static_V2.mp3');
